...
For App Store purchases: charges are processed via your Apple ID account.
For Google Play purchases: charges are processed via your Google account.

You can manage or cancel your subscription through your respective platform's account settings.
...
(c) The availability of AI-Assisted Features may be limited by technical capacity, temporarily or permanently unavailable without notice, subject to usage quotas that may change at any time, restricted based on geographic location or platform, or modified, suspended, or discontinued at our sole discretion.
...
By submitting UGC, you retain ownership of your content, but you grant the Company a worldwide, non-exclusive, royalty-free license to store, display, and use your UGC solely as necessary to operate and provide the App's functionality to you and, where applicable, to other users.
...
(b) You grant the Company a worldwide, non-exclusive, royalty-free, perpetual, and irrevocable license to use, reproduce, modify, and analyze Generated Content for the purposes of operating and improving the App and AI-Assisted Features, ensuring compliance with applicable laws and this Agreement, training and improving our AI models (in anonymized form), and detecting and preventing abuse or misuse of our services.
...
(b) Create content that infringes or misappropriates any third-party intellectual property rights;
...
(e) We may implement rate limiting, usage quotas, or temporary restrictions on AI-Assisted Features at any time to ensure service stability and fair usage across all users.
...
(a) AI-Assisted Features are experimental and provided on a limited availability basis. Access may be intermittent or unavailable during peak usage periods, subject to daily, weekly, or monthly usage limits, prioritized based on factors we determine in our sole discretion, or terminated or suspended without notice.
...
(c) The experimental nature of AI-Assisted Features means they may produce inconsistent results, be modified substantially without notice, experience extended periods of unavailability, or be permanently discontinued.
...
infringes the rights of others, including intellectual property, privacy, or publicity rights;
is defamatory, obscene, offensive, or otherwise inappropriate;
promotes or facilitates unlawful, harmful, or abusive behavior, including hacking, unauthorized access, or copyright infringement.

You must not:

sublicense, resell, lease, lend, or distribute the App to any third party;
modify, translate, reverse engineer, decompile, or create derivative works based on the App;
attempt to bypass, disable, or interfere with any security features or technical limitations;
use the App in any way that harms or interferes with our systems, services, or users.
...
11. AVAILABILITY, COMPATIBILITY, AND UPDATES
...
AI-Assisted Features, when available, require active internet connectivity and communication with third-party AI service providers. These features may be unavailable due to third-party service outages or limitations, rate limiting by AI service providers, cost or technical constraints, compliance or legal requirements, or our discretion to limit or suspend access.
...
We may, at our sole discretion, update, enhance, modify, suspend, or remove features, content, or functionality from the App at any time, with or without notice.

Service Interruptions and Data Loss

You acknowledge and agree that the App may experience interruptions, delays, downtime, or temporary outages due to technical reasons, system maintenance, upgrades, or factors beyond our control. The Company shall not be responsible or liable for any loss of data, content, or functionality, or for any inconvenience or damages arising from such interruptions or downtime.

12. IMPORTANT LEGAL NOTICE
This Agreement includes important legal provisions that affect your rights, including:

Binding Arbitration: In some jurisdictions, any disputes arising out of or relating to this Agreement may be resolved through individual arbitration, instead of court proceedings.
Class Action Waiver: You may be required to bring claims only in your individual capacity and not as a plaintiff or class member in any class or representative proceeding.
Disclaimers and Limitations: Sections below include disclaimers of warranties and limitations of liability related to the use of the App.

Please read this Agreement carefully to understand your rights and obligations. By continuing to use the App, you confirm that you have read and agreed to all its terms.
...
warranties of accuracy, reliability, uninterrupted availability, or that the App will meet your expectations or requirements;
warranties that the App or any content will be error-free or that any defects will be corrected;
warranties that the App or the servers that make it available are free of viruses or other harmful components;
warranties that AI-Assisted Features will be available at any particular time or at all, or that they will meet any specific performance standards or usage requirements.

We do not guarantee that any information, content, or features in the App are accurate, complete, or reliable.
...
15. INDEMNIFICATION
To the maximum extent permitted by applicable law, you agree to indemnify, defend, and hold harmless the Company, its affiliates, successors, officers, directors, employees, agents, partners, licensors, and contractors from and against any and all claims, demands, losses, liabilities, damages, costs, and expenses (including reasonable attorneys' fees) arising out of or related to your access to or use of the App, your breach of any applicable laws or regulations, your violation of any third-party rights, or any User-Generated Content you submit, post, or otherwise make available through the App.
...
You and we waive any right to a jury trial and agree that all claims must be brought individually, and not as a plaintiff or class member in any class or representative proceeding.

Location and Law: The arbitration shall be conducted in English and governed by the U.S. Federal Arbitration Act. The place of arbitration shall be Delaware, unless the parties agree otherwise.
Small Claims Exception: Either party may bring an individual claim in small claims court for matters within that court's jurisdiction.
Equitable Relief: Either party may seek injunctive or equitable relief in a court of competent jurisdiction to protect intellectual property rights.

16.2 Opt-Out

You may opt out of this arbitration agreement within 30 days of accepting these Terms by contacting us at main@nocapps.art.
...
17. COMMUNICATION AND CUSTOMER SUPPORT
Support. If you have any questions, concerns, or need assistance regarding the App, you may contact us using the information provided in the Contact Us section. We are not obligated to provide support, but may choose to do so at our discretion.

Feedback. We welcome your feedback. By submitting any suggestions, comments, ideas, ratings, or other feedback through the App, you assign to us all rights, title, and interest in and to such feedback, which we may use without obligation or compensation.

18. ELECTRONIC COMMUNICATIONS
By using the App, you consent to receive all communications, notices, and legal disclosures from us electronically, including via email or through in-App notifications.

19. COPYRIGHT INFRINGEMENT NOTIFICATION
We respect the intellectual property rights of others and take claims of copyright infringement seriously. If you believe that content in our App violates your copyright or other intellectual property rights, please contact us at main@nocapps.art.

20. TERMINATION
We reserve the right to suspend, limit, or terminate this Agreement and your access to the App at any time, with or without prior notice, if you violate any term of this Agreement, applicable laws, or regulations.

Upon termination, all rights and licenses granted to you under this Agreement shall immediately cease, and you must immediately stop all use of the App and uninstall it from your devices.
...
No Waiver. Our failure to enforce any provision of these Terms shall not be deemed a waiver of our right to enforce it later.
...
Assignment. You may not assign your rights under these Terms without our prior written consent. We may assign or transfer our rights and obligations at any time without notice.
